    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          <div className="md:flex space-x-6 xl:space-x-24 pr-6 md:pr-20 lg:pr-32 hidden">
            <Image
              src="/em1.png"
              width={"900"}
              height={"900"}
              alt="svg by Vitaliy Gorbachev"
              className="not-selectable w-16 h-16 lg:w-28 lg:h-28 xl:w-36 xl:h-36 hidden md:block"
              style={{
                animation: "fade-in 1s ease-in",
                opacity: isLoading ? 0 : 1,
                objectPosition: "center 50%",
        ...
        <div
          className="flex-col justify-between text-justify text-brand-gold text-base md:text-lg lg:text-xl mx-auto items-center top-0 left-0 px-12 pb-6 md:px-20 lg:px-32 md:py-8 bg-brand-deep fade-in"
          style={{
            animation: "fade-in 0.5s ease-in",
          }}
          onLoad={handleImageLoad}
        >
          <p>
            ...
            propósito principal es realzar la belleza natural, retrasar el
            envejecimiento y brindar un aspecto más rejuvenecido y saludable."
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto flex items-center justify-center md:justify-between">
          {isLoading ? (
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="rounded-lg border-[0.25rem] border-brand-gold overflow-hidden md:ml-4 lg:ml-12 mb-8 md:mb-0 fade-in">
                <Image
                  src="/nenau.jpg"
                  width={584}
                  height={655}
                  ...
                  priority
                  className="not-selectable object-fill w-[20rem] h-[22.43rem] md:w-[45rem] md:h-[22rem] lg:w-[43rem] lg:h-[22rem] xl:w-[46rem] xl:h-[22rem]"
                  style={{
                    animation: "fade-in 1s ease-in",
                    opacity: isLoading ? 0 : 1,
                  }}
              ...
              <div className="flex flex-col ml-8 md:ml-20 lg:ml-20 xl:ml-32 fade-in md:mr-2 lg:mr-8 xl:mr-20">
                ...
                <div className="mt-6">
                  <p className="container font-montserrat text-sm lg:text-base text-justify text-gray-800 pr-12 md:pr-0 lg:pr-2 mb-2">
