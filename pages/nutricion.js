    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <p className="font-montserrat text-base md:text-lg text-brand-sand mx-8 md:mx-16 mb-2">
            Nuestro equipo está dedicado a brindarte la orientación y
        ...
        <div className="container mx-auto flex items-center justify-center md:justify-between">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="flex flex-col md:ml-20 lg:ml-20 xl:ml-32 fade-in md:mr-2 lg:mr-8 xl:mr-20">
              <div>
                <p className="font-montserrat text-center md:text-start text-base md:text-xl text-gray-800 mb-2">
                  LIC. TOMAS SALAS
                </p>
              </div>
              <div>
                <p className="font-montserrat text-center md:text-start text-sm lg:text-lg text-gray-800 mb-2">
              ...
              <div className="flex mt-6 ml-8 md:ml-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="container font-montserrat text-sm lg:text-base text-justify text-gray-800 pl-2 pr-9 md:pr-0 lg:pr-2"
                >
              ...
              <div className="flex mt-2 ml-8 md:ml-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="container font-montserrat text-sm lg:text-base text-justify text-gray-800 pl-3 pr-9 md:pr-0 lg:pr-2"
                >
                  @tomassalas.nutri
                </a>
              </div>
      ...
      <div className="bg-brand-seasalt pt-10 pb-14">
        <div className="container mx-auto flex items-center justify-center md:justify-between">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="flex flex-col md:ml-20 lg:ml-20 xl:ml-32 fade-in md:mr-2 lg:mr-8 xl:mr-20">
              <div>
                <p className="font-montserrat text-center md:text-start text-base md:text-xl text-gray-800 mr-4 md:mr-0 mb-2">
                  KRYSTAL ARRAMBIDE
                </p>
              </div>
              <div>
                <p className="font-montserrat text-center md:text-start text-sm lg:text-lg text-gray-800 mr-4 md:mr-0 mb-2">
                  INSTRUCTORA CERTIFICADA - ISSA
                </p>
              </div>
              <div className="mt-5 ml-8 md:ml-0">
                <p className="container font-montserrat text-sm lg:text-base text-justify text-gray-800 pr-9 md:pr-0 lg:pr-2">
                  Con una gran dedicación y compromiso hacia el mundo del
                  acondicionamiento físico, la instructora Krystal Arrambid
                  tiene la formación y certificación necesaria en el campo para
                  brindar un enfoque personalizado a cada uno de sus clientes.
                  Su pasión por inspirar y motivar a otros hacia una vida activa
                  y saludable es evidente en su enfoque dinámico y energético.
                </p>
              </div>
              <div className="flex mt-6 ml-8 md:ml-0">
                <svg
              ...
              <div className="flex mt-2 ml-8 md:ml-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="container font-montserrat text-sm lg:text-base text-justify text-gray-800 pt-[0.125rem] md:pt-0 pl-2 pr-9 md:pr-0 lg:pr-2"
                >
      ...
      {hasScrolled && isButtonVisible && (
        <div className="fixed bottom-6 md:bottom-8 right-2 md:right-6 z-10">
          <Link
            ...
            target="_blank"
            className="bg-brand-seasalt border-[0.225rem] border-brand-opakeppel font-poppins text-brand-opakeppel text-base md:text-lg px-4 py-2 rounded-full hover:bg-brand-opakeppel hover:text-brand-seasalt"
            style={{
