...
export default function Rehabilitacion() {
  ...
  return (
    <div>
      ...
      <OtherHeader />
      <div className="flex flex-col md:flex-row justify-between bg-brand-sapphire">
        <div
          className="flex justify-center items-center top-0 left-0 pb-4 pt-7 md:pb-4 md:pt-10 bg-brand-shamrock-green fade-in"
          style={{
        ...
        >
          <div className="md:w-1/2">
            <Image
              ...
              alt="pic"
              priority
              className="not-selectable w-[15rem] h-[6.725rem] md:w-auto md:h-auto mx-auto fade-in"
              style={{
        ...
        <div
          className="flex justify-center items-center top-0 left-0 pb-4 pt-7 md:pb-4 md:pt-10 bg-brand-sapphire fade-in"
          style={{
            animation: "fade-in 0.5s ease-in",
          }}
        >
