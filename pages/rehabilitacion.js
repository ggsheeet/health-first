              ...
              <div className="flex flex-col ml-8 md:ml-20 lg:ml-20 xl:ml-32 fade-in md:mr-2 lg:mr-8 xl:mr-20">
                ...
                <div className="mt-6">
                  <p className="container font-montserrat text-sm lg:text-base text-justify text-gray-800 pr-9 md:pr-0 lg:pr-2">
                    ...
                    Autónoma de Nuevo León y su especialización en
                    rehabilitación física, el Dr. Marcelo González desarrolló
                    una pasión por ayudar a sus pacientes a recuperar su
                    funcionalidad y mejorar su calidad de vida de la mano de
                    técnicas y tratamientos de vanguardia para así brindar una
                    atención y manejo de alta calidad ante diversos
