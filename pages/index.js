  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Clínica médica que otorga servicios generales de atención médica así como tratamientos específicos de medicina estética y fisioterapia"
        />
            ...
            <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-brand-creamy z-20 overflow-auto">
              <div className="md:flex-row md:space-x-16 space-y-10 mt-8 md:mt-6 w-full">
                <div className="font-notosans text-center text-brand-seasalt px-2 md:px-28 py-10 mt-1">
                  <p className="text-2xl md:text-3xl mx-auto mb-0 mt-4 md:mt-8 whitespace-pre-wrap text-center items-center">
                    <span className="font-extrabold text-base sm:text-xl md:text-2xl">
                      {" "}
                      {"HEALTH FIRST | WELLNESS CENTER"}
                    </span>
                  </p>
                  <p className="font-montserrat mt-6 md:mt-12 mb-16 text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
      ...
      <div className="flex flex-col bg-slate-100 bg-opacity-90 items-center justify-center font-montserrat text-justify text-brand-ultra-violet mx-auto px-16 md:px-24 xl:px-32 pt-12 pb-6 md:pb-16">
        <p className="text-lg md:text-2xl mb-3">Acerca de Nosotros</p>
        <div className="w-1/4 md:w-1/4 lg:w-1/6 xl:w-1/12 h-0.5 bg-brand-ultra-violet rounded-full mb-6"></div>
        <p className="text-sm md:text-lg pb-6">
          Health First Wellness Center es una clínica dedicada a brindar
          servicios de consulta general y atención a urgencias menores.
          Nuestro objetivo es proporcionar un enfoque integral y personalizado
          para el cuidado de la salud de nuestros pacientes.
        </p>
        <p className="text-sm md:text-lg pb-6">
          En Health First, valoramos la atención médica de calidad y nos
          esforzamos por ofrecer un ambiente cálido y acogedor donde los
          pacientes se sientan cómodos y seguros. Ya sea que necesite una consulta médica
          de rutina, tratamiento para una dolencia menor o atención urgente, en
          Health First estamos aquí para cuidar de usted y su familia.
        </p>
      </div>
      ...
      <div className="relative grid grid-rows-1 lg:grid-cols-2">
        <div
      ...
      <div className="bg-gray-100 opacity-90 text-lg md:text-2xl overflow-hidden m-8 lg:mx-16 md:my-12 p-6 md:p-12 ring-4 rounded-sm shadow-xl ring-brand-keppel">
        <div className="relative flex items-center space-x-2 md:space-x-3">
          <p className="font-raleway text-brand-ultra-violet border-b-2 border-brand-keppel">
            Farmacia
          </p>
