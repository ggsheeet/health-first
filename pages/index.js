    ...
    <div>
              ...
              <div className="md:flex-row md:space-x-16 space-y-10 mt-8 md:mt-6 w-full">
                <div className="font-notosans text-center text-brand-seasalt px-2 md:px-28 py-10 mt-1">
                  ...
                  <div className="flex items-center">
                    ...
                    target="_blank"
                      noreferrer="true"
                      className="cursor-pointer p-1 md:p-2 mx-auto bg-transparent rounded-full border-[0.15rem] md:border-2 border-brand-seasalt hover:bg-brand-seasalt hover:text-brand-navy"
                    >
      ...
      <div className="flex flex-col bg-slate-100 items-center justify-center font-montserrat text-justify text-brand-ultra-violet mx-auto px-10 md:px-24 xl:px-32 pt-12 pb-6 md:pb-16">
        ...
        <p className="text-sm md:text-lg pb-6">
          <span className="font-montserrat font-semibold">Health First Wellness Center</span> es una clínica dedicada a brindar
          servicios de consulta general y atención a urgencias menores. Nuestro
          objetivo es proporcionar un enfoque integral y personalizado para el
          cuidado de la salud de nuestros pacientes.
        </p>
        <p className="text-sm md:text-lg pb-6">
          En <span className="font-montserrat font-semibold">Health First</span>, valoramos la atención médica de calidad y nos
          esforzamos por ofrecer un ambiente cálido y acogedor donde los
          pacientes se sientan cómodos y seguros. Ya sea que necesite una
          consulta médica de rutina, tratamiento para una dolencia menor o
          atención urgente, en Health First estamos aquí para cuidar de usted y
          su familia.
        </p>
      </div>
          ...
          <div>
            <div className="rounded-lg border-[0.25rem] border-brand-ultra-violet overflow-hidden fade-in">
              <Image
                ...
                priority
                className="not-selectable object-fill w-full h-full md:w-full md:h-full lg:w-full lg:h-full xl:w-full xl:h-full"
                style={{
                  animation: "fade-in 1s ease-in",
                }}
              />
            </div>
            <p className="text-center mt-4">Médico</p>
            <p className="text-center mb-8 md:mb-0">Dr. Marcelo González</p>
          </div>
          <div>
            <div className="rounded-lg border-[0.25rem] border-brand-ultra-violet overflow-hidden fade-in">
              <Image
            ...
            <p className="text-center mt-4">Enfermero</p>
            <p className="text-center mb-8 md:mb-0">Marcelo González</p>
          </div>
          <div>
            <div className="rounded-lg border-[0.25rem] border-brand-ultra-violet overflow-hidden fade-in">
              <Image
            ...
            <p className="text-center mt-4">QFB</p>
            <p className="text-center mb-6 md:mb-0">Marcelo González</p>
          </div>
        </div>
      </div>
