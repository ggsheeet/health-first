      ...
      <footer id="footer" className="bg-slate-200 font-raleway py-6">
        <div className="container mx-auto pl-8 pr-8 md:pl-10 md:pr-12 lg:pl-10 lg:pr-16">
          <div className="flex flex-wrap justify-between">
            <div className="w-full sm:w-auto mb-4">
              ...
              <p className="font-montserrat text-brand-navy text-xs sm:text-sm md:text-base">
                {
                  "Horas de trabajo: Lun - Vie 08:00 - 17:00 | Sab 08:00 - 13:00"
                }
              </p>
            </div>
            <div className="w-full sm:w-auto mb-4">
              ...
              <p className="text-brand-navy font-montserrat text-xs sm:text-sm md:text-base mt-2 mb-1 flex items-center whitespace-pre-wrap">
                <svg
                ...
                <a href="tel:81-1414-1616" className="pl-1 md:pl-0">
                  {"  "}
                  {"81-1414-1616"}
                </a>
                <a>{" / "}</a>
                <a href="tel:81-1717-1818">{"81-1717-1818"}</a>
              </p>
              <p className="text-brand-navy text-xs sm:text-sm md:text-base flex items-center whitespace-pre-wrap">
                ...
                <a href="mailto:drmarcelogzz@gmail.com">
                  {"   "}
                  {"drmarcelogzz@gmail.com"}
                </a>
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row mx-auto justify-between mt-6 md:mt-2 font-notosans text-brand-ultra-violet text-xs">
            ...
            <div>
              <p className="cursor-pointer hover:border-b-[0.0125rem] hover:inline-block hover:border-b-brand-ultra-violet">
                Aviso de Privacidad
              </p>
            </div>
          </div>
