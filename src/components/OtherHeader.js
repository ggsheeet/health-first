    ...
    <div className="w-full z-50">
      ...
      <header className="text-brand-ultra-violet min-w-full z-50 py-2 pl-8 pr-8 md:pl-4 md:pr-3 lg:pl-12 lg:pr-8 xl:pl-44 xl:pr-32 hidden md:block bg-slate-100">
        <div className="flex items-center container mx-auto justify-between h-[4rem]">
          ...
          <nav aria-label="Tab Menu" className="navbar-menu">
            <ul className="text-xs xl:text-sm flex items-center space-x-4 md:space-x-5 lg:space-x-10 text-brand-ultra-violet --font-noto">
        ...
        <nav className="flex items-center justify-between px-8 py-1">
          ...
          {isMenuOpen && (
            ...
            >
              ...
              <ul className="flex flex-col pl-20 --font-noto pt-14">
      ...
      >
        <div className="flex justify-between py-4 md:pr-14 lg:pr-20 xl:pr-36 md:pl-16 lg:pl-28 xl:pl-44 items-center">
          <LinkToTop />
          <nav aria-label="Tab Menu" className="navbar-menu">
            <ul className="text-xs lg:text-sm xl:text-base flex space-x-4 md:space-x-6 lg:space-x-8 text-brand-ultra-violet --font-noto">
              <li className="cursor-pointer menu-item">
              <Link href="/" rel="noopener noreferrer">
                  {" "}
                  Consulta{" "}
